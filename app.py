...
<div class="main-header">
    ...
    <p>Tác giả: Phạm Thị Thu Thúy - Trường Tiểu học Minh Khương  - ĐT: 097 421 188</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phạm Thị Thu Thúy - Trường Tiểu học Minh Khương - ĐT: 097 421 188 </div>", unsafe_allow_html=True)
